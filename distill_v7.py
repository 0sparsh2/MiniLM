...
def main():
    ...
    # Universal 6-Layer Instruct Model -> Exactly 4.00 MB
    print(f"Initializing V7 Student (Universal 6-Layer)...")
    student_model = BitGPT(vocab_size, embed_dim=256, num_layers=6, num_heads=4, tie_weights=True, universal=True).to(device)
    ...
    print("Starting V7 Universal Instruct Distillation (1000 steps)...")
    ...
    torch.save(student_model.state_dict(), "bitnet_instruct_v7.pt")
    print("Saved to bitnet_instruct_v7.pt (4.00 MB)")
